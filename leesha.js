...
const channelContextInfo = {
  ...
  forwardedNewsletterMessageInfo: {
    ...
    newsletterName: '𝑸𝒖𝒆𝒆𝒏 𝑳𝒆𝒆𝒔𝒉𝒂 𝑼𝒑𝒅𝒂𝒕𝒆𝒔 🇦🇱'
  },
};
...
`   QUEEN LEESHA MD V1 `, 'red');
  console.log(header);
  console.log(line);
  console.log(color(` 𝐆𝐫𝐨𝐮𝐩 𝐂𝐡𝐚𝐭... `, 'green'));
  console.log(logColor(` 𝐓𝐈𝐌𝐄  : ${myfunc.getTime()}`, 'blue'));
  console.log(logColor(` 𝐍𝐀𝐌𝐄  : ${pushname}`, 'red'));
  console.log(logColor(` 𝐆𝐑𝐎𝐔𝐏  : ${groupName}`, 'green'));
  console.log(logColor(`𝐉𝐈𝐃 : ${m.chat}`, 'blue'));
  console.log(line);
  console.log(logColor(` 𝐌𝐄𝐒𝐒𝐀𝐆𝐄  : ${budy || m.mtype}`, 'red'));
  console.log(logColor(` 𝐅𝐑𝐎𝐌  : ${m.sender}`, 'green'));
  console.log(line);
} else {
  const logColor = (text, colorName) => color(`┃${text}`, colorName);
  const line = color(
...
`   QUEEN LEESHA MD V1 `, 'red');
  console.log(header);
  console.log(line);
  console.log(color(` 𝐏𝐫𝐢𝐯𝐚𝐭𝐞 𝐂𝐡𝐚𝐭... `, 'green'));
  console.log(logColor(` 𝐓𝐈𝐌𝐄 : ${myfunc.getTime()}`, 'blue'));
  console.log(logColor(` 𝐍𝐀𝐌𝐄 : ${pushname}`, 'red'));
  console.log(logColor(` 𝐉𝐈𝐃 : ${m.sender}`, 'green'));
  console.log(line);
  console.log(logColor(` 𝐌𝐄𝐒𝐒𝐀𝐆𝐄  : ${budy || m.mtype}`, 'blue'));
  console.log(line);
}
...
try {
  ...
  const caption = `𝚃𝙸𝙺𝚃𝙾𝙺 𝙳𝙾𝚆𝙽𝙻𝙾𝙰𝙳𝙴𝚁
...
> POWERED BY KALLMETRUST`;
  ...
  const captionn = `*𓊈 🌟 TIKTOK DOWNLOADER 🌟𓊉*
...
//=========================================\\
        ...
        if (isgclink) return devtrust.sendMessage(m.chat, {text: `\`\`\`「 Group Link Detected 」\`\`\`\n\n You will not be kicked by bots because what you sent was a link to this group`})
        if (isAdmins) return devtrust.sendMessage(m.chat, {text: `\`\`\`「 Group Link Detected 」\`\`\`\n\n Admin sends a link, admin is free to post any link`})
        if (DanzTheCreator) return devtrust.sendMessage(m.chat, {text: `\`\`\`「 Group Link Detected 」\`\`\`\n\n owner has sent a link, owner is free to post any link`})
        kice = m.sender
        await devtrust.sendMessage(m.chat,
			    {
			        delete: {
...
if (budy.toLowerCase() == jawaban) {
   devtrust.sendMessage(m.chat, { image: { url: 'https://files.catbox.moe/06g8rb.jpg' }, caption: `🎮 Guess the Song 🎮\n\nCorrect Answer 🎉\n\nWant to play again? Please type Guess the song`}, {quoted:m}) 
...
await devtrust.sendText(m.chat, `🎮 Guess the Flag 🎮\n\Correct Answer 🎉`, m)
delete tebakbendera2[m.sender.split('@')[0]]
            } else console.log('*Wrong Answer!*')
        }
...
await devtrust.sendText(m.chat, `🎮 Guess the Picture 🎮\n\nCorrect Answer 🎉`, m)
delete tebakbendera[m.sender.split('@')[0]]
            } else console.log('*Wrong Answer!*')
        }
...
await devtrust.sendText(m.chat, `🎮 Guess the District 🎮\n\nCorrect Answer 🎉`, m)
delete tebakkabupaten[m.sender.split('@')[0]]
            } else console.log('*Wrong Answer!*')
        }
...
await devtrust.sendText(m.chat, `🎮 Guess Chemistry 🎮\n\nCorrect Answer 🎉`, m)
delete tebakkimia[m.sender.split('@')[0]]
            } else console.log('*Wrong Answer!*')
        }
...
users.money += devtrust.tekateki[id][2]
 var teks = `*PUZZLE GAME*\n\nYour Answer is Correct!\n Prizes : +${devtrust.tekateki[id][2]} Money 💸`
 replynano(`${teks}`)
...
await devtrust.sendText(m.chat, `🎮 Brain Teaser 🎮\n\nCorrect Answer 🎉`, m)
delete tebakasahotak[m.sender.split('@')[0]]
            } else console.log('*Wrong Answer!*')
        }
//=========================================\\
...
var teks = `*GAME WHO AM I*\n\nYour Answer is Correct!\n Prize : +${devtrust.siapaaku[id][2]} Money 💸`
   replynano(`${teks}`)
...
users.money += devtrust.susunkata[id][2]
   var teks = `*WORD COMPOSITION GAMES*\n\nYour Answer is Correct!\n Prizes : +${devtrust.susunkata[id][2]} Money 💸`
replynano(`${teks}`)
...
if (budy.toLowerCase() == jawaban) {
 devtrust.sendMessage(m.chat, { image: { url: 'https://files.catbox.moe/06g8rb.jpg' }, caption: `🎮 Guess Lontong 🎮\n\nCorrect Answer 🎉\n\nWant to play again? Please type Guess Lontong`}, {quoted:m}) 
...
if (budy.toLowerCase() == jawaban) {
 devtrust.sendMessage(m.chat, { image: { url: 'https://files.catbox.moe/06g8rb.jpg' }, caption: `🎮 Guess the Sentence 🎮\n\nCorrect Answer 🎉\n\nWant to play again? Please type Guess the sentence`}, {quoted:m}) 
...
user.money += devtrust.tebaklirik[id][2]
 global.db.users[m.sender].exp += 10
   var teks = `*LYRIC GUESSING GAME*\n\nYour Answer is Correct!\n Prizes : +${devtrust.tebaklirik[id][2]} Money 💸\n EXP: +10`
  replynano(`${teks}`)
...
if (budy.toLowerCase() == jawaban) {
 devtrust.sendMessage(m.chat, { image: { url: 'https://files.catbox.moe/06g8rb.jpg' }, caption: `🎮 Guess Guess 🎮\n\nCorrect Answer 🎉\n\nWant to play again? Please type Guess`}, {quoted:m}) 
...
if (!DanzTheCreator) return reply(mess.only.owner)
replynano(`𝑫𝒐𝒏𝒆 𝑹𝒆𝒔𝒕𝒂𝒓𝒕𝒊𝒏𝒈 𝑸𝒖𝒆𝒆𝒏 𝑳𝒆𝒆𝒔𝒉𝒂 𝑴𝒅`)
await sleep(3000)
process.exit()}
break
//case 'totalfeature':
...
`; // Added direct chat link
    ...
    setTimeout(async () => {
      ...
      const ownerName = " 👑 𝙁𝘼𝙈Ø𝙐𝙎 𝘿𝙀𝙑 👑"; // Define the desired name here
...
│
│ 💫 Hello, *${pushname || 'User'}*!
│ 🤖 I'm *Queen Leesha MD-V1*, your loyal AI assistant.
│ 👑 Always ready to help, guide, or vibe!
│
╰─━━━━━━━━━━━━━━━━━━━━━━━
> ⚡ *Powered by DevTrust*
    `.trim();
...
case "autoreact": {if (prefix === '.') {
    if (!DanzTheCreator) return reply('᥆ᥒᥣᥡ 𝖿᥆r mᥡ ᥣ᥆᥎ᥱᥣᥡ ᥆ᥕᥒᥱr ');

    // Parse command for 'on' or 'off'
    const args = text.trim().split(' ')[0];
    if (!args || !["on", "off"].includes(args)) {
        return reply('Usage: *autoreact on* 𝙾𝚁 *autoreact off*');
    }
...
◆ *MODE:* ${getPublicModeStatus() ? 'public' : 'self'}
◆ *MOOD:* 🌸 (24h rotation)
...
┃ ${prefix}gbt4 <𝗊ᥙᥱrᥡ>
┃ ${prefix}metaai <𝗊ᥙᥱrᥡ>
┃ ${prefix}chatbot <𝗊ᥙᥱrᥡ>
┃ ${prefix}photoai <𝗊ᥙᥱrᥡ>
┃ ${prefix}openai <𝗊ᥙᥱrᥡ>
┃ ${prefix}google <𝗊ᥙᥱrᥡ>
┃ ${prefix}sparkai <𝗊ᥙᥱrᥡ>
┃ ${prefix}autoaigc <᥆ᥒ/᥆𝖿𝖿>
┃ ${prefix}gemini <𝗊ᥙᥱrᥡ>
┃ ${prefix}realistic <𝗊ᥙᥱrᥡ>
┃ ${prefix}luminai <𝗊ᥙᥱrᥡ>
┃ ${prefix}help
┃
┗━━━━━━━━━━━━━━
...
⚙️ Powered by *Lord Trust* | *Queen Leesha*`
...
case 'luminai':{
      try {
        ...
        await veloria.sendMessage(m.chat, {react: {text: '💬', key: m.key}})
...
╭─「 💻 *Queen Leesha — PANEL* 」─╮
│
│ *.panel* — Open your hosting panel
│ *.listusr* — View all users
│ *.delusr* — Delete a user
│ *.listsrv* — View all servers
│ *.delsrv* — Delete a server
│ *.tutorial* — Setup & guide
│ *.ramlist* — Check RAM plans
│ *.premlist* — Premium users
│ *.addusr* — Add new user
│ *.addsrv* — Add a new server
│ *.updatesrv* — Update server info
...
╭───❍ *⚙️ System Info* ❍───╮
│ 📝 *Name:* Queen Leesha MD
│ 🧑‍💻 *Owner:* Kallmetrust
│ 🔖 *Version:* v1.0.0
│ 💬 *Prefix:* ${prefix}
│ 📊 *Total Cmds:* ${totalCases}
│ ⏱ *Uptime (Bot):* ${format(uptime)}
│ 🖥 *Uptime (VPS):* ${format(vpsUptime)}
│ 📟 *RAM Used:* ${usedMemory} MB / ${totalMemory} MB
│ 💾 *Free RAM:* ${freeMemory} MB
│ ⚡ *CPU:* ${cpuModel} ${cpuSpeed}MHz
│ 🌐 *Platform:* ${process.platform} ${os.release()}
│ 🔧 *Runtime:* Node.js ${process.version}
│ 📍 *Ping:* ${latensi?.toFixed(2) ?? '0.00'} ms
╰───────────────────────╯

✨ 𝑸𝒖𝒆𝒆𝒏 𝒍𝒆𝒆𝒔𝒉𝒂 𝒎𝒅 𝒊𝒔 𝒓𝒖𝒏𝒏𝒊𝒏𝒈 𝒔𝒎𝒐𝒐𝒕𝒉𝒍𝒚
...
break
case 'manga': {
    if (!text) return replynano(`⚠️ Usage: ${command} <manga name>\n\nExample: ${command} naruto`)
...
🔗 More: ${data.url}`
        ...
        console.error(e)
        m.reply("⚠️ Failed to fetch manga info. Try again later.")
    }
}
break
case 'npm': {
    if (!text) return replynano(`⚠️ Usage: ${command} <package>\n\nExample: ${command} axios`)
...
│ 📅 *DATE:* ${xdate}
│ 🧍‍♂️ *USER:* ${pushname}
│ ⚙️ *MODE:* ${devtrust.public ? 'PUBLIC' : 'SELF'}
│ ⏱️ *UPTIME:* ${uptime}
╰──────────────────────────╯

╭───「 💻 *Bot Information* 」───╮
│ 👑 *Developer:* ${ownername}
│ 🤖 *Engine:* Auto-mated WhatsApp AI
│ 🧠 *Version:* V1 Stable
╰──────────────────────────╯

╭───「 💖 *Credits* 」───╮
│ 🧑‍💻 *Creator:* Lord ${ownername}
│ 🎨 *Designs By:* Trust
│ 🙏 *Special Thanks:* 
│ To all my followers and supporters 
│ who inspired me to keep building.
╰─────────────────────────╯

✨ *Queen Leesha MD-V1 — The Best Automated WhatsApp Bot*
`;
...
break 
case 'metaai': {
    if (!text) return replynano(`💡 Usage: ${command} <your question>\n\nExample: ${command} what is a noun`)
    ...
    try {
        ...
        console.error(e)
        m.reply("⚠️ Sorry, MetaAI could not respond. Please try again later.")
    }
}
break
case 'roast': {
    ...
    try {
        ...
        m.reply(`🔥 *Roast for ${target}:*\n\n${roast}`)
    } catch (e) {
        console.error(e)
        m.reply("⚠️ Failed to roast. Try again later.")
    }
}
break
case 'photoai': {
  if (!text) return replynano(`⚠️ Usage: ${prefix + command} <your prompt>\n\nExample: ${prefix + command} a cat wearing sunglasses`)
...
break;
case 'storyai': {
    if (!text) return replynano(`⚠️ Usage: ${command} <topic>\n\nExample: ${command} a brave dog in space`)
...
case 'wouldyou': {
  try {
    ...
    console.error(e);
    m.reply("⚠️ Failed to generate a question, try again later.");
  }
}
break;
case 'truthdare': case 'tod': {
  if (!text) return replynano(`⚠️ Usage: ${command} truth | dare\n\nExample:\n${command} truth\n${command} dare`);
  ...
  try {
    ...
    if (!type) return replynano("⚠️ Please choose either *truth* or *dare*.");
    ...
    console.error(e);
    m.reply("❌ Failed to fetch Truth/Dare. Try again later.");
  }
}
break;
case 'rate': {
    if (!text) return replynano(`⚠️ Usage: ${command} <something>\n\nExample: ${command} Trust's coding skills`)

    let percentage = Math.floor(Math.random() * 100) + 1
    let bar = "⭐".repeat(Math.floor(percentage / 10)) + "✩".repeat(10 - Math.floor(percentage / 10))

    replynano(`📊 *Rate Machine* 📊\n\n${text}\n\nRating: *${percentage}%*\n${bar}`)
}
break;
case 'ship': {
    if (!text) return replynano(`⚠️ Usage: ${command} <name1> & <name2>\n\nExample: ${command} Trust & Dev`)

    let names = text.split("&")
    if (names.length < 2) return m.reply("⚠️ Please use format: name1 & name2")
...
case 'sc': {
  if (prefix === '.') {
    ...
    const infoText = `
╭───「 *Queen Leesha MD-V1 Info* 」───╮
│ 👑 *Developer:* DevTrust
│ 🌎 *Website:* coming soon
│ 🎬 *YouTube:* ${yt}
│ 👤 *User:* ${pushname}
│ 💡 *Note:* Follow all socials to get the full bot source.
╰────────────────────────────╯
`;
    ...
    setTimeout(async () => {
      const repoText = `
🌟 *HEY ${pushname}!*  
So you want to deploy *Queen Leesha MD-V1*? Let’s get you started 👇

╭─「 ⚙️ Deployment Steps 」─╮
│ 1️⃣ Tap on *REPO* below.
│ 2️⃣ ⭐ Star and *Fork* the repository on GitHub.
│ 3️⃣ Tap *Code → Download ZIP*.
│ 4️⃣ Go to *YouTube*, Subscribe & Watch the full tutorial.
│ 5️⃣ Follow the steps carefully to deploy your bot.
│ 6️⃣ Then, tap *Channel* to get updates and new features.
╰────────────────────────────╯
...
`;
  ...
  case 'channel': { if (prefix === '.') { let chan ='ȷ᥆іᥒ 𝗍һᥱ ᥴһᥲᥒᥒᥱᥣ ᑲᥱᥣ᥆ᥕ, 𝖿᥆r 𝗊ᥙᥱᥱᥒ ᥣᥱᥱsһᥲ ᥙ⍴ძᥲ𝗍ᥱ.'
...
if (!DanzTheCreator) return reply(mess.only.owner)
replynano('ᥕᥲі𝗍 ᥲ sᥱᥴ, ᥴᥙrrᥱᥒ𝗍ᥣᥡ gᥱ𝗍𝗍іᥒg ᥡ᥆ᥙr sᥱssі᥆ᥒ filᥱ, kᥱᥱ⍴ і𝗍 sᥲ𝖿ᥱ.')
...
//=========================================\\
    ...
    case 'twdl': {
      if (!text || !text.startsWith("https://")) {
        return replynano("❌ Please provide a valid/real Twitter URL.");
      }
...
try {
  ...
  const vidnya = data.video.noWatermark
  const caption = `*𝗊ᥙᥱᥱᥒ ᥣᥱᥱsһᥲ 𝗍іk𝗍᥆k*
...
//==============================================
      ...
      if (prefix === '.') {
        ...
        try {
          ...
          await devtrust.sendMessage(m.chat, { react: { text: '✅', key: m.key } }); // Success reaction
...
devtrust.relayMessage(m.chat, { reactionMessage }, { messageId: '🦄' })
}}
break
...
case 'bible2':{if (prefix === '.') 
 ...
      devtrust.sendFile(m.chat, foto, 'alkitab.jpg', `${judul}\n\n${caption}`, m)
 } 
break
...
case 'statusbot': {
  if (prefix === '.') {
    ...
    const response = `
╭─『 *🤖 Queen Leesha MD-V1 System Status* 』
│
│ ⚡ *Response Speed:* ${latency}s
│ ⏱️ *Runtime:* ${uptime}
│ 💬 *Ping:* ${(neww - oldd).toFixed(4)}ms
│
╰─━━━━━━━━━━━━━━━━━━━━━━━
...
│ 🪫 *NodeJS Memory:*
│ ${Object.keys(used)
        .map(k => `│ • ${k.padEnd(10)}: ${formatp(used[k])}`)
        .join('\n')}
│
╰─━━━━━━━━━━━━━━━━━━━━━━━
...
│ ${Object.keys(cpu.times)
        .map(t => `│ • ${t.padEnd(6)}: ${(100 * cpu.times[t] / cpu.total).toFixed(2)}%`)
        .join('\n')}
│
│ _Per Core (${cpus.length} Cores):_
│ ${cpus
        .map(
          (c, i) =>
            `│ Core ${i + 1}: ${c.model.trim()} (${c.speed} MHz)\n${Object.keys(c.times)
              .map(t => `│  • ${t.padEnd(6)}: ${(100 * c.times[t] / cpu.total).toFixed(2)}%`)
              .join('\n')}`
        )
        .join('\n\n')}
│
...
> ⚡ *Powered by DEVTRUST & Queen Leesha MD-V1*
`.trim();
...
╭───「 🔒 *GROUP MUTED* 」───╮
│
│ 🕯️ *Queen Leesha MD-V1* has locked the group.
│ 🌙 No one (except admins) can send messages.
│ 💬 “It’s time to rest and keep peace in the realm.”
│
│ ♡゙ Good ${timeOfDay()}, everyone. Rest easy. 💐
│
╰────────────────────────────╯`;
...
╭───「 🔓 *GROUP UNMUTED* 」───╮
│
│ 🌸 *Queen Leesha MD-V1* has reopened the group!
│ 💫 Everyone may now send messages again.
│
│ 💎 Type *.menu* to see all commands.
│ 🌐 Visit: ${saluran} for script info.
│
│ ☀️ “Let’s deploy some greatness together!” 🚀
│
╰────────────────────────────╯`;
...
⚙️ Invalid option.
Use:
> .mute close  — to lock the group
> .mute open   — to unlock the group`;
...
devtrust.sendMessage(from, {text: ` *WARNING* \n\nNobody is allowed to use bad words in this group, anyone who uses will be kicked immediately, don't dare me 😈`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
...
case 'tagall': {
  if (prefix === '.') {
    ...
    let me = m.sender;
    let message = q ? q : "No message provided 👀";
...
devtrust.sendMessage(m.chat, { react: { text: `⏱️`, key: m.key }})
try{
...
case 'bank': { if (prefix === '.') {
    ...
    let caption = `
💸「 *BANK* 」
│ 🙂 Name: ${user.registered ? user.name: devtrust.getName(m.sender)}
...
${sortedItem.slice(page * 0, page * 5 + 5).map((user, i) => `${i + 1}.*﹙${user[type]}﹚*- ${participants.some(p => areJidsSameUser(user.jid, p.id)) ? `${user.registered ? user.name: devtrust.getName(user.jid)} \nwa.me/`: 'ғʀᴏᴍ ᴏᴛʜᴇʀ ɢʀᴏᴜᴩ\n @'}${user.jid.split`@`[0]}`).join`\n\n`}
`.trim()
...
devtrust.level = global.db.users[m.sender]
  ...
  if (typeof devtrust.fightnaga[m.sender] != "undefined" && devtrust.fightnaga[m.sender] == true) return reply(`*Can't fight ⚔️ because the Arena you own is used to fight your other pets.*`)
  ...
  if (pointPemain > pointLawan){
    ...
    reply(`*${devtrust.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${devtrust.getName(lawan)}*\n\n*Pet🐉You* (dragon ${global.db.users[m.sender].naga}) WIN against the 🐉dragon *${devtrust.getName(lawan)}* (naga ${global.db.users[lawan].naga}) because of your dragon🐉 ${alasanMenang[Acakin(0,alasanMenang.length-1)]}\n\nPresent Rp. ${hadiah.toLocaleString()}\n+1 Tiketcoin`)
  }else if (pointPemain < pointLawan){
    let denda = (pointLawan - pointPemain) * 100000
    global.db.users[m.sender].money -= denda
    global.db.users[m.sender].tiketcoin += 1
    reply(`*${devtrust.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${devtrust.getName(lawan)}*\n\n*Pet🐉You* (dragon ${global.db.users[m.sender].naga}) LOST against the 🐉dragon *${devtrust.getName(lawan)}* (naga ${global.db.users[lawan].naga}) because of your pet ${alasanKalah[Acakin(0,alasanKalah.length-1)]}\n\nYour money is reduced by Rp. ${denda.toLocaleString()}\n+1 Tiketcoin`)
  }else {
...
devtrust.level = global.db.users[m.sender]
  ...
  if (pointPemain > pointLawan){
    ...
    global.db.users[m.sender].money += hadiah
    global.db.users[m.sender].tiketcoin += 1
    reply(`*${devtrust.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${devtrust.getName(lawan)}*\n\n*Pet🦊You* (kyubi ${global.db.users[m.sender].kyubi}) MENANG against his 🦊kyubi *${devtrust.getName(lawan)}* (kyubi ${global.db.users[lawan].kyubi}) because of your kyubi🦊 ${alasanMenang[Acakin(0,alasanMenang.length-1)]}\n\nPresent Rp. ${hadiah.toLocaleString()}\n+1 Tiketcoin`)
  }else if (pointPemain < pointLawan){
    let denda = (pointLawan - pointPemain) * 100000
    global.db.users[m.sender].money -= denda
    global.db.users[m.sender].tiketcoin += 1
    reply(`*${devtrust.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${devtrust.getName(lawan)}*\n\n*Pet🦊You* (kyubi ${global.db.users[m.sender].kyubi}) KALAH against his 🦊kyubi *${devtrust.getName(lawan)}* (kyubi ${global.db.users[lawan].kyubi}) because of your pet ${alasanKalah[Acakin(0,alasanKalah.length-1)]}\n\nYour money is reduced Rp. ${denda.toLocaleString()}\n+1 Tiketcoin`)
  }else {
    reply(`*${devtrust.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${devtrust.getName(lawan)}*\n\nIf you draw, you won't get anything 😂`)
  }
...
devtrust.level = global.db.users[m.sender]
  ...
  if (pointPemain > pointLawan){
    ...
    global.db.users[m.sender].money += hadiah
    global.db.users[m.sender].tiketcoin += 1
    reply(`*${devtrust.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${devtrust.getName(lawan)}*\n\n*Pet🦅You* (phonix ${global.db.users[m.sender].phonix}) WIN against his 🦅phonix *${devtrust.getName(lawan)}* (phonix ${global.db.users[lawan].phonix}) because of your phonix🦅 ${alasanMenang[Acakin(0,alasanMenang.length-1)]}\n\nGift Rp. ${hadiah.toLocaleString()}\n+1 Tiketcoin`)
  }else if (pointPemain < pointLawan){
    let denda = (pointLawan - pointPemain) * 10000
    global.db.users[m.sender].money -= denda
    global.db.users[m.sender].tiketcoin += 1
    reply(`*${devtrust.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${devtrust.getName(lawan)}*\n\n*Pet🦅You* (phonix ${global.db.users[m.sender].phonix}) LOSE the fight 🦅phonixnya *${devtrust.getName(lawan)}* (phonix ${global.db.users[lawan].phonix}) because of your pet${alasanKalah[Acakin(0,alasanKalah.length-1)]}\n\nYour money is reduced Rp. ${denda.toLocaleString()}\n+1 Tiketcoin`)
  }else {
    reply(`*${devtrust.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${devtrust.getName(lawan)}*\n\nIf you draw, you won't get anything 😂`)
  }
...
devtrust.level = global.db.users[m.sender]
  ...
  if (pointPemain > pointLawan){
    ...
    global.db.users[m.sender].money += hadiah
    global.db.users[m.sender].tiketcoin += 1
    reply(`*${devtrust.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${devtrust.getName(lawan)}*\n\n*Pet🐈You* the cat ${global.db.users[m.sender].kucing}) WIN against 🐈the cat *${devtrust.getName(lawan)}* (cat ${global.db.users[lawan].kucing}) karena kucing🐈you ${alasanMenang[Acakin(0,alasanMenang.length-1)]}\n\nGift Rp. ${hadiah.toLocaleString()}\n+1 Tiketcoin`)
  }else if (pointPemain < pointLawan){
    let denda = (pointLawan - pointPemain) * 100000
    global.db.users[m.sender].money -= denda
    global.db.users[m.sender].tiketcoin += 1
    reply(`*${devtrust.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${devtrust.getName(lawan)}*\n\n*Pet🐈You* the cat ${global.db.users[m.sender].kucing}) LOSE the fight 🐈the cat *${devtrust.getName(lawan)}* the cat ${global.db.users[lawan].kucing}) because of your pet${alasanKalah[Acakin(0,alasanKalah.length-1)]}\n\nYour money is reduced Rp. ${denda.toLocaleString()}\n+1 Tiketcoin`)
  }else {
    reply(`*${devtrust.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${devtrust.getName(lawan)}*\n\nIf you draw, you won't get anything 😂`)
  }
...
devtrust.level = global.db.users[m.sender]
  ...
  if (pointPemain > pointLawan){
    ...
    global.db.users[m.sender].money += hadiah
    global.db.users[m.sender].tiketcoin += 1
    m.reply(`*${devtrust.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${devtrust.getName(lawan)}*\n\n*Pet🦚You* (griffin ${global.db.users[m.sender].griffin}) WIN against 🦚The griffin *${devtrust.getName(lawan)}* (griffin ${global.db.users[lawan].griffin}) because of your griffin   ${alasanMenang[Acakin(0,alasanMenang.length-1)]}\n\nGift Rp. ${hadiah.toLocaleString()}\n+1 Tiketcoin`)
  }else if (pointPemain < pointLawan){
    let denda = (pointLawan - pointPemain) * 100000
    global.db.users[m.sender].money -= denda
    global.db.users[m.sender].tiketcoin += 1
    m.reply(`*${devtrust.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${devtrust.getName(lawan)}*\n\n*Pet🦚You* (griffin ${global.db.users[m.sender].griffin}) LOSE the fight 🦚The griffin *${devtrust.getName(lawan)}* (griffin ${global.db.users[lawan].griffin}) because of your pet${alasanKalah[Acakin(0,alasanKalah.length-1)]}\n\nYour money is reduced Rp. ${denda.toLocaleString()}\n+1 Tiketcoin`)
  }else {
    m.reply(`*${devtrust.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${devtrust.getName(lawan)}*\n\nIf you draw, you won't get anything 😂`)
  }
...
devtrust.level = global.db.users[m.sender]
  ...
  if (typeof devtrust.fightnaga[m.sender] != "undefined" && devtrust.fightnaga[m.sender] == true) return m.reply(`*Can't fight ⚔️ because the Arena you own is used to fight your other pets.*`)
  ...
  if (pointPemain > pointLawan){
    ...
    global.db.users[m.sender].money += hadiah
    global.db.users[m.sender].tiketcoin += 1
    m.reply(`*${devtrust.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${devtrust.getName(lawan)}*\n\n*Pet🐴You* (centaur ${global.db.users[m.sender].centaur}) WIN against 🐴the centaur *${devtrust.getName(lawan)}* (centaur ${global.db.users[lawan].centaur}) karena centaur🐴you ${alasanMenang[Acakin(0,alasanMenang.length-1)]}\n\nGift Rp. ${hadiah.toLocaleString()}\n+1 Tiketcoin`)
  }else if (pointPemain < pointLawan){
    let denda = (pointLawan - pointPemain) * 100000
    global.db.users[m.sender].money -= denda
    global.db.users[m.sender].tiketcoin += 1
    m.reply(`*${devtrust.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${devtrust.getName(lawan)}*\n\n*Pet🐴You* (centaur ${global.db.users[m.sender].centaur}) LOSE the fight 🐴the centaur *${devtrust.getName(lawan)}* (centaur ${global.db.users[lawan].centaur}) because of your pet${alasanKalah[Acakin(0,alasanKalah.length-1)]}\n\nYour money is reduced Rp. ${denda.toLocaleString()}\n+1 Tiketcoin`)
  }else {
    m.reply(`*${devtrust.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${devtrust.getName(lawan)}*\n\nIf you draw, you won't get anything 😂`)
  }
...
case 'hunt': { if (prefix === '.') {
  ...
  return [h, m, s].map(v => v.toString().padStart(2, 0) ).join(':')
    ...
    if (new Date - user.lastmisi > 3600000) {
		...
		let hsl = `🕸 *Hunting Results ${user.registered ? user.name : devtrust.getName(m.sender)}* 
${hewan1 ? `
🐂 Bull: ${hewan1}` : ''} ${hewan2 ? `
🐅 Tiger: ${hewan2}` : ''} ${hewan3 ? `
...
${prefix + command} <username>`);
        ...
        try {
            ...
            const ctf = `
*hey @${u.split`@`[0]} here is your panel account details📦*

*📡 𝗦𝗲𝗿𝘃𝗲𝗿 𝗜𝗱 : (${user.id})* 
*👥 𝗨𝘀𝗲𝗿𝗻𝗮𝗺𝗲 :* ${user.username}
*🔐 𝗣𝗮𝘀𝘀𝘄𝗼𝗿𝗱 :* ${password}
*🌐 𝗟𝗼𝗴𝗶𝗻 𝗱𝗼𝗺𝗮𝗶𝗻 :* ${global.domain} 
*📝 𝗠𝗲𝗺𝗼𝗿𝘆: ${server.limits.memory === 0 ? '𝐔𝐍𝐋𝐈𝐌𝐈𝐓𝐄𝐃' : server.limits.memory} 
...
let inventory = {
  ...
  let caption = `
🧑🏻‍🏫 ᴜsᴇʀ: *${user.registered ? user.name : devtrust.getName(who)}* ${user.level ? `
  ...
  try {
    if (/repair/i.test(command)) {
      ...
      switch (_type) {
        ...
        default:
          return devtrust.sendButton( m.chat, caption, wm, null, [`⋮☰ Menu`, `.menu`], m)
      }
    }
  } catch (err) {
    m.reply("Error\n\n\n" + err.stack)
...
function random(arr) {
  ...
  devtrust.tembak = devtrust.tembak || { musuh: [], tembak: [] }
   if(/kiri/i.test(text)) {
    ...
    if(devtrust.tembak.tembak.indexOf("🤠") == 0) {
      devtrust.tembak.tembak = kiri[0]
    } else if(devtrust.tembak.tembak.indexOf("🤠") == 1) {
      devtrust.tembak.tembak = kiri[0]
    } else if(devtrust.tembak.tembak.indexOf("🤠") == 2) {
      devtrust.tembak.tembak = kiri[1]
    } else if(devtrust.tembak.tembak.indexOf("🤠") == 3) {
      devtrust.tembak.tembak = kiri[2]
    } else if(devtrust.tembak.tembak.indexOf("🤠") == 4) {
    ...
    if(devtrust.tembak.musuh.indexOf("🥷") === devtrust.tembak.tembak.indexOf("🤠")) return devtrust.sendButton(m.chat, pos, wm, [
    ...
    if(devtrust.tembak.tembak.indexOf("🤠") == devtrust.tembak.musuh.indexOf("🥷")) {
      devtrust.tembak = {}
...
const timeout = 604800000
    ...
    setTimeout(() => {
        reply(`Come on, it's time to thief 🇦🇱😈…`)
    }, timeout)
}}
break
//==================================================================
...
case 'help': {
    if (prefix === '.') {
        const helpText = `
╭━━━〔 💡 *HELP & SUPPORT* 〕━━━╮
│ ⚙️ Need help deploying this bot?
│ 🤖 Want to create or use your own bot?
│ 🎓 Or confused about setup and hosting?
│
│ 📢 *Join our official channel below*
│ 👉 https://whatsapp.com/channel/0029VbAaOJLInlqVwhwtxS33
│
│ 🎥 *Watch our YouTube tutorial too!*
│
╰━━━〔 ⚡ TRUST-BIT 🇦🇱 〕━━━╯
> 𝗣𝗼𝘄𝗲𝗿𝗲𝗱 𝗯𝘆 *DevTrust 💠*
`;
    ...
    setTimeout(async () => {
      const rulesText = `
╭━〔 QUEEN LEESHA BOT RULES 〕━╮

⚠️ *Use the bot wisely!*  
Don’t spam commands — repeated spam can lead to a ban.
...
💬 *Bot not responding?*  
If it doesn’t reply the first time, try again once.  
If it still doesn’t respond, the server may be delayed — wait a bit.
...
🗣️ *Need help?*  
Ask another user or request the bot’s official channel link to join.  
Stay connected for updates and tutorials.

📢 *Found a bug or error?*  
Report directly to the *Owner* t.me/KallmeTrust for assistance.

🐢 *If the bot feels slow or delayed* — please wait,  
don’t flood it with more commands.

🔰 *Prefix Reminder:*  
Always check the bot’s prefix before using commands to prevent unexpected issues.

╰━━━━━━━━━━━━━━━━━━━━━━━━━━╯
> 💠 𝗣𝗼𝘄𝗲𝗿𝗲𝗱 𝗯𝘆 𝗗𝗲𝘃𝗧𝗿𝘂𝘀𝘁 x 𝗤𝘂𝗲𝗲𝗻 𝗟𝗲𝗲𝘀𝗵𝗮 👑
`;
...
case 'payment': {
    try {
        ...
        const menya = `
╭━━〔 💳 PAYMENT DETAILS 〕━━╮
│ 👤 *Account Name:* ${global.bankowner}
│ 🏦 *Bank Name:* ${global.bankname}
│ 💰 *Account Number:* ${global.banknumber}
│
│ 📸 *After making payment, send a screenshot.*
│
╰━━〔 ⚡ TRUST-BIT 🇦🇱 〕━━━╯
> 𝗣𝗼𝘄𝗲𝗿𝗲𝗱 𝗯𝘆 *DevTrust 💠*
`;
        ...
        await devtrust.sendMessage(
            m.chat,
            { text: "⚠️ Failed to send payment details. Please try again later." },
            { quoted: repPy }
        );
    }
...
if (isAutoAiGc) return reply(`am active ✌️😝`)
...
case 'reportbug': {
  if (prefix === '.') {
    const ownerNumber = '2347041560392'; // 🔹 Replace with your WhatsApp number (e.g., 2347041560392)
    const telegramUser = '@KallmeTrust'; // 🔹 Replace with your Telegram username

    const reportMsg = `
╭─━❰  *BUG REPORT CENTER*  ❱━─╮
│
│ ⚠️ Found a glitch, bug, or system crash?
│ Please report it immediately to help us
│ keep *Queen Leesha MD-V1* running smoothly!
│
│ ━━━━━━━━━━━━━━━━━━━━━━━
│ 👑 *Developer:* DevTrust
│
...
│ • Avoid unnecessary chatting — be specific.
│ • Never call or video call the owner’s line.
│ • Reports should include screenshots or logs.
│
│ Example:
│ .reportbug Bot stopped responding after .menu
│
╰─────────────────────────╯
> ⚙️ *Powered by Queen Leesha MD-V1*
`;
...
┃𝟳gᑲ 𝗨𝗦𝗘𝗥𝗡𝗔𝗠𝗘,𝗡𝗨𝗠𝗕𝗘𝗥
┃𝟴gᑲ 𝗨𝗦𝗘𝗥𝗡𝗔𝗠𝗘,𝗡𝗨𝗠𝗕𝗘𝗥
┃𝗨𝗡𝗟𝗜 𝗨𝗦𝗘𝗥𝗡𝗔𝗠𝗘,𝗡𝗨𝗠𝗕𝗘𝗥
┗━━━━━━━━━━━━━━━━


┏━ 𖠄 𝗘𝗫𝗔𝗠𝗣𝗟𝗘 𝗙𝗢𝗥 𝗦𝗘𝗥𝗩𝗘𝗥 𝟭:
┃
┃𝗥𝗔𝗠 𝗨𝗦𝗘𝗥𝗡𝗔𝗠𝗘,𝗡𝗨𝗠𝗕𝗘𝗥
┃𝟭gᑲ testing,2347042560695
┗━━━━━━━━━━


┏━ 𖠄  𝗦𝗘𝗥𝗩𝗘𝗥 𝟮
┃
┃𝗦𝗥𝗩𝟮𝟭gᑲ 𝗨𝗦𝗘𝗥𝗡𝗔𝗠𝗘,𝗡𝗨𝗠𝗕𝗘𝗥
┃𝗦𝗥𝗩𝟮𝟮gᑲ 𝗨𝗦𝗘𝗥𝗡𝗔𝗠𝗘,𝗡𝗨𝗠𝗕𝗘𝗥
┃𝗦𝗥𝗩𝟮𝟯gᑲ 𝗨𝗦𝗘𝗥𝗡𝗔𝗠𝗘,𝗡𝗨𝗠𝗕𝗘𝗥
┃𝗦𝗥𝗩𝟮𝟰gᑲ 𝗨𝗦𝗘𝗥𝗡𝗔𝗠𝗘,𝗡𝗨𝗠𝗕𝗘𝗥
┃𝗦𝗥𝗩𝟮𝟱gᑲ 𝗨𝗦𝗘𝗥𝗡𝗔𝗠𝗘,𝗡𝗨𝗠𝗕𝗘𝗥
┃𝗦𝗥𝗩𝟮𝟲gᑲ 𝗨𝗦𝗘𝗥𝗡𝗔𝗠𝗘,𝗡𝗨𝗠𝗕𝗘𝗥
┃𝗦𝗥𝗩𝟮𝟳gᑲ 𝗨𝗦𝗘𝗥𝗡𝗔𝗠𝗘,𝗡𝗨𝗠𝗕𝗘𝗥
┃𝗦𝗥𝗩𝟮𝟴gᑲ 𝗨𝗦𝗘𝗥𝗡𝗔𝗠𝗘,𝗡𝗨𝗠𝗕𝗘𝗥
┃𝗦𝗥𝗩𝟮𝗨𝗡𝗟𝗜 𝗨𝗦𝗘𝗥𝗡𝗔𝗠𝗘,𝗡𝗨𝗠𝗕𝗘𝗥
┗━━━━━━━━━━━━


┏━ 𖠄 𝗘𝗫𝗔𝗠𝗣𝗟𝗘 𝗙𝗢𝗥 𝗦𝗘𝗥𝗩𝗘𝗥 𝟮: 
┃
┃𝗦𝗥𝗩𝟮𝗥𝗔𝗠 𝗨𝗦𝗘𝗥𝗡𝗔𝗠𝗘,𝗡𝗨𝗠𝗕𝗘𝗥
┃𝗦𝗥𝗩𝟮𝟭gᑲ testing,2347042560695
┗━━━━━━━━
...
case 'ramlist': {
  if (prefix === '.') {
    ...
    const text12 = `
👋 Hey *@${sender.split("@")[0]}*, here’s the full RAM server configuration list:
...
╭─
│ RAM USERNAME,NUMBER
│ 1GB → testing,2347042560695
╰─

╭━━━〔 ⚙️ SERVER 2 LIST 〕━━━╮
┃ SRV21GB → USERNAME, NUMBER
┃ SRV22GB → USERNAME, NUMBER
┃ SRV23GB → USERNAME, NUMBER
┃ SRV24GB → USERNAME, NUMBER
┃ SRV25GB → USERNAME, NUMBER
┃ SRV26GB → USERNAME, NUMBER
┃ SRV27GB → USERNAME, NUMBER
┃ SRV28GB → USERNAME, NUMBER
┃ SRV2UNLI → USERNAME, NUMBER
╰━━━━━━━━━━━━━━━━━━━━━━━━━╯

📌 *Example for SERVER 2:*
╭─
│ SRV2RAM USERNAME,NUMBER
│ SRV21GB → testing,2347042560695
╰─
...
let server = res.attributes
let p = await reply(`
*panel account details has been sent to number📦*
...
const ctf = `*hey @${u.split`@`[0]} here is your panel account details📦*
...
if (res.errors) return reply(JSON.stringify(res.errors[0], null, 2))
let server = res.attributes
let p = await reply(`*panel account details has been sent to number📦*
...
case 'runtime': {
  if (prefix === '.') {
    ...
    const uptimeText = `
╭─『 ⏱️ *Queen Leesha MD-V1 Uptime* 』
│ 🤖 *Uptime:* ${uptime}
│ 🕒 *Active:* ${hours}h ${minutes}m ${seconds}s
│ 💻 *System:* NodeJS ${process.version}
...
{ quoted: m})        
 ...
 case 'couple': {
            ...
            let jodoh = member[Math.floor(Math.random() * member.length)]
devtrust.sendMessage(m.chat,
{ text: `@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}Aww 🤭`,
contextInfo:{
...
let link = 'https://chat.whatsapp.com/' + await devtrust.groupInviteCode(group)
      await devtrust.sendMessage(text+'@s.whatsapp.net', {text: `≡ *GROUP INVITATION*\n\nA user invites you to join this group \n\n${link}`, mentions: [m.sender]})
...
devtrust.sendMessage(m.chat, { caption: `≡  *XNXX DL*
...
if (!text) return replynano('What location?')
            ...
            textw += `*✨ feeling:-* ${wdata.data.main.feels_like}\n`
